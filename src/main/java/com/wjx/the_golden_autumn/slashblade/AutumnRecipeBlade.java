...
public class AutumnRecipeBlade extends ShapedOreRecipe {
    ...
    public AutumnRecipeBlade(ResourceLocation group, ItemStack result,ItemStack inheritBlade, Object... recipe) {
     ...
     * @param recipe 合成
     */
    public AutumnRecipeBlade(ResourceLocation group, ItemStack result,ItemStack inheritBlade, List<ItemStack> materialBlade, Object... recipe) {
