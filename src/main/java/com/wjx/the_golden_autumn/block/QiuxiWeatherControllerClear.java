...
public class QiuxiWeatherControllerClear {
    public static class CustomTile extends ControlTileEntityBase {
        ...
        public ITextComponent getDisplayName() {
            return new TextComponentString("QiuXi Weather Controller Clear");
        }

        @Override
        public String getName() {
            return "qiuxi_weather_controller_clear";
        }
        ...
        public void update() {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            if (getValuebool(worldIn,new BlockPos((int) x, (int) y, (int) z), "tianqikongzhi_clear")) {
    ...
    public static class CustomBlock extends ControlBlockBase {
        public CustomBlock(){
            super();
            setUnlocalizedName("qiuxi_weather_controller_clear");
            setRegistryName("qiuxi_weather_controller_clear");
        ...
        public TileEntity createNewTileEntity(World worldIn, int meta) {
            return new QiuxiWeatherControllerClear.CustomTile();
        }

        @Override
        public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
            super.addInformation(stack, player, tooltip, advanced);
            tooltip.add(updatecolor.makeColourSanic(I18n.translateToLocal("info.weather_clear")));
        }
        ...
        public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
            ...
            if (worldIn.isBlockIndirectlyGettingPowered(new BlockPos(x,y,z)) > 0){
                ...
                if (!worldIn.isRemote){
                    ...
                    if (_tileEntity != null){
                        _tileEntity.getTileData().setBoolean("tianqikongzhi_clear", true);
                ...
                if (!worldIn.isRemote){
                    ...
                    IBlockState _bs = worldIn.getBlockState(_bp);
                    if (_tileEntity != null){
                        _tileEntity.getTileData().setBoolean("tianqikongzhi_clear", false);
