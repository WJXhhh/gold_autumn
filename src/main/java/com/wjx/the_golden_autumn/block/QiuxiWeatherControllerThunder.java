...
public class QiuxiWeatherControllerThunder {
    public static class CustomTile extends ControlTileEntityBase {
        ...
        public ITextComponent getDisplayName() {
            return new TextComponentString("QiuXi Weather Controller Thunder");
        }

        @Override
        public String getName() {
            return "qiuxi_weather_controller_thunder";
        }
    ...
    public static class CustomBlock extends ControlBlockBase {
        public CustomBlock(){
            super();
            setUnlocalizedName("qiuxi_weather_controller_thunder");
            setRegistryName("qiuxi_weather_controller_thunder");
        ...
        public TileEntity createNewTileEntity(World worldIn, int meta) {
            return new QiuxiWeatherControllerThunder.CustomTile();
        }
        ...
        public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
            ...
            if (worldIn.isBlockIndirectlyGettingPowered(new BlockPos(x,y,z)) > 0){
                ...
                if (!worldIn.isRemote){
                    ...
                    if (_tileEntity != null){
                        _tileEntity.getTileData().setBoolean("tianqikongzhi_thunder", true);
                ...
                if (!worldIn.isRemote){
                    ...
                    IBlockState _bs = worldIn.getBlockState(_bp);
                    if (_tileEntity != null){
                        _tileEntity.getTileData().setBoolean("tianqikongzhi_thunder", false);
