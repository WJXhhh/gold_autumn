...
public class BlockQiu_Rose extends BlockFlower implements IHasModel, ITileEntityProvider {

    public BlockQiu_Rose(){
        setUnlocalizedName("qiurose");
        setRegistryName("qiurose");
        setCreativeTab(TabGold);
        blockinit.Blocks.add(this);
        iteminit.ITEMS.add(new ItemBlock(this).setRegistryName(this.getRegistryName()));
        GameRegistry.registerTileEntity(CustomTile.class,"qiu_rose");
    }

    @Override
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
        super.addInformation(stack, player, tooltip, advanced);
        tooltip.add(I18n.format("info.qiurose"));
    }
